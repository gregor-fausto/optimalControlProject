...
pwt=10; lambda=lambda1=1; fvals = numeric(10);  
...
saveRDS(out,paste0("~/Dropbox/optimalControlProject/discretize-optimize/runs/unbranched-determinate/",dataName,".RDS") )
functions<-list(f1,f2,f3)
saveRDS(functions,paste0("~/Dropbox/optimalControlProject/discretize-optimize/runs/unbranched-determinate/",functionName,".RDS") )
