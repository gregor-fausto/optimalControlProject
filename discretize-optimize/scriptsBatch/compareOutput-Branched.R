...
outputVec<-outputVec[c(grep("branchedDeterminate-uniform-1-",outputVec))]
...
outputVec<-outputVec[c(grep("branchedDeterminate-uniform-",outputVec))]
outputVec<-outputVec[!grepl("unbranched",outputVec)]
...
refMatSorted=refMat[order(refMat$m),]
