...
initsName <- paste0(initsList[["distribution"]],"-",initsList[["seasonParms"]]["max"],"-",initsList[["mParms"]]["m1"],"-",initsList[["mParms"]]["alpha"],gParm)
...
saveRDS(summaryObject,paste0("~/Dropbox/optimalControlProject/discretize-optimize/analysisSeven/",controlName,"-",initsName,".RDS"))
