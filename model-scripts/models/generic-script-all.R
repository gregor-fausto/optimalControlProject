...
##############################################################
# Sensitivity analysis: reduce alpha and meristem constraints
##############################################################
pwt=10; lambda=1; 
...
dir.create(file.path(paste0("model-scripts/",analysisName,"/")), showWarnings=FALSE)
saveRDS(summaryObject,paste0("model-scripts/",analysisName,"/",controlName,"-",initsName,"-relaxAlphaMeristem.RDS"))
